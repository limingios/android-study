...
//        String path = Environment.getExternalStorageDirectory() + "/stu.db";
        SQLiteOpenHelper helper = new SQLiteOpenHelper(this,"stu.db",null,2) {
            @Override
            public void onCreate(SQLiteDatabase sqLiteDatabase) {
                ...
                Toast.makeText(DataBaseActivity.this,"数据库创建",Toast.LENGTH_SHORT).show();
            ...
            public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
                //升级
                Toast.makeText(DataBaseActivity.this,"数据库升级",Toast.LENGTH_SHORT).show();
            }
        };
...
//                db.execSQL();         添加、删除、修改、创建表
                ...
                //String sql = "insert into test_tb (name,age,gender) values ('"+nameStr+"',"+ageStr+",'"+genderStr+"')";
                String sql = "insert into test_tb (name,age,gender) values (?,?,?)";
            ...
            case R.id.select_btn:
                ...
                String sql2 = "select * from test_tb";
                if(!idStr.equals("")){
            ...
            case R.id.delete_btn:
                String sql3 = "delete from test_tb where _id=?";
                db.execSQL(sql3,new String[]{idStr});
                Toast.makeText(this,"删除成功",Toast.LENGTH_SHORT).show();
                break;
            case R.id.update_btn:
                String sql4 = "update test_tb set name=? , age=? , gender=?  where _id=?";
