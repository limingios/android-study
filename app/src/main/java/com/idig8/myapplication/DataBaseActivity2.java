...
//        String path = Environment.getExternalStorageDirectory() + "/stu.db";
        SQLiteOpenHelper helper = new SQLiteOpenHelper(this,"stu.db",null,2) {
            ...
            public void onCreate(SQLiteDatabase sqLiteDatabase) {
                ...
                Toast.makeText(DataBaseActivity2.this,"数据库创建",Toast.LENGTH_SHORT).show();
            ...
            public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
                //升级
                Toast.makeText(DataBaseActivity2.this,"数据库升级",Toast.LENGTH_SHORT).show();
            }
        };
...
//在SqliteDatabase类下，提供四个方法
                ...
                long id = db.insert("test_tb",null,values);
            ...
            case R.id.select_btn:
                ...
                //参数7:排序
                Cursor c = db.query("test_tb",null,null,null,null,null,null);
            ...
            case R.id.delete_btn:
                int count = db.delete("test_tb","_id=?",new String[]{idStr});
                if(count > 0) {
